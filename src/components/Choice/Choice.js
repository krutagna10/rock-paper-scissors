...
const Choice = (props) => {
  ...
  return (
    <div className="choice container grid">
      <button
        className="choice___btn icon-background icon-background--paper"
        aria-label="paper"
        data-choice="paper"
      ...
      <button
        className="choice___btn icon-background icon-background--scissors"
        aria-label="scissors"
      ...
      <button
        className="choice___btn icon-background icon-background--rock"
        aria-label="rock"
        data-choice="rock"
        onClick={clickHandler}
      >
